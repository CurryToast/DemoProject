	...
	<div id="page-wrapper">
		...
		<section id="read">
			...
			<form name="frm1" method="post" action="update">
				<!-- type이 hidden이면 출력은 되지 않고 파라미터로 전달하고 싶은 값에 사용합니다. -->
				<input type="hidden" name="idx" value="${vo.idx }"> <input type="hidden" name="page" value="${page}">
				...
				<table>
					...
					<tr>
						<th>작성 날짜</th>
						<td>
							<input type="text" value="${vo.createdAt}" disabled>
						</td>
					</tr>
					<tr>
						<th>내용</th>
