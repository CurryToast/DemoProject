...
<body class="is-preload">
	<div id="page-wrapper">
		...
		<section id="book">
			...
			<!--
				주의 : enctype 속성을 꼭 확인하세요.
				파일과 문자열 데이터를 같이 보낼 때 필요.
			-->
			<form action="save" method="post" enctype="multipart/form-data">
				<table style="width: 50rem;">
					<tr>
						...
						<td>
							<input type="text" name="saleuser" value="${user.userid}" readonly>
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<input type="text" name="bcode" accept="image/*" required>
						</td>
					</tr>
					<tr>
						<th>
					...
					<tr>
						...
						<td>
							<input type="text" name="pubdate" placeholder="YYYY-MM-DD">
						</td>
					</tr>
					<tr>
						<th style="width: 25%;">
