...
<html>
	...
	<body class="is-preload">
		...
		<script type="text/javascript">
			...
			/*
				비동기 콩신의 다른 방법 : axios 라이브러리. 우리 서버 table에 정보를 insert하기 위한 통신
				함수 requestPaymentSave는 async (비동기) 처리한다는 의미입니다.
			*/
			async function requestPaymentSave(payReq) {
				// await는 axios가 post 요청을 보낸 후 응답을 기다린다는 의미입니다.
			...
			const payReq = {
				bcode: payment.orderId.substring(0,7),
			...
			// 함수 실행
			requestPaymentSave(payReq).then(result => { // then : 요청이 성공했을때 실행
